...
|`HIDRTX`|`86`/`0x56`| Pop **ONE** item off TOS as `ADDR`<br>Read **9 bytes**<br>Construct & send raw HID message<br>[See also `HIDRTX()` in duckyScript doc](https://github.com/dekuNukem/duckyPad-Pro/blob/master/doc/duckyscript_info.md)|
